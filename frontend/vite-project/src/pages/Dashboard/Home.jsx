...
import CREATE_ICON from "../../assets/images/penImg.png";
...
const Home = () => {
  ...
  useEffect(() => {
    ...
    fetchAllPolls(1);
    return () => {};
  }, [filterType]); // Runs when filterType changes
        ...
        >
          {allPolls.map((poll) => (
            <PollCard
              ...
              creatorProfileImg={poll.creator?.profileImageUrl || null} // ✅ Safe check added
              creatorName={poll.creator?.fullName || "Unknown"} // ✅ Safe check added
              creatorUsername={poll.creator?.username || "Anonymous"} // ✅ Safe check added
